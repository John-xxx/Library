...
public class MultipleAdapter<T> extends RecyclerView.Adapter<SuperHolder> {
     ...
     * @param <T>
     */
    private static class RuleManage<T> {
        ...
        /**
         * 根据目标数据查找对应规则
         * {@link MultipleAdapter#onBindViewHolder(SuperHolder, int)}
         * @param object
         * @return
         */
