...
public class ActivityStarter {
    ...
    public static void startActivityForResult(Activity activity, Intent intent, Callback callback) {
        synchronized (activity) {
            if (activity instanceof FragmentActivity) {
                innerSupportFragmentForResult((FragmentActivity) activity, intent, callback);
            } else {
    ...
    private static void innerSupportFragmentForResult(FragmentActivity activity, Intent intent, Callback callback) {
