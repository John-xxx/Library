...
public class DownloadConnection implements FileDownloadConnection {
    ...
    public DownloadConnection(Request.Builder builder, OkHttpClient client) {
        mRequestBuilder = builder;
        mClient = client;
    }

    public DownloadConnection(String url, OkHttpClient client) {
    ...
    public static class Creator implements FileDownloadHelper.ConnectionCreator {
         ...
         *
         * @param client the client for customizing the okHttp client.
         */
        ...
        public FileDownloadConnection create(String url) throws IOException {
            ...
            return new DownloadConnection(url, mClient);
        }
    }
}